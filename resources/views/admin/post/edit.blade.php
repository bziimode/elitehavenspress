            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/update-post/'.$post->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="article_date" value="{{ $post->article_date }}" name="article_date" class="form-control" placeholder="Date of Article. Click to select date" />
                    </div>
                    <div class="mb-3">
                        <label>Publish Date</label>
                        <input type="date" id="publish_date" value="{{ $post->publish_date }}" name="publish_date" class="form-control" placeholder="Click to select a date from calendar or type a specific date" />
                    </div>
                    <div class="mb-3">
                        <label>Author</label>
